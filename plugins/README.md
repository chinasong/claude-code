...
| [concept-consistency-review](./concept-consistency-review/) | Review concept drift, claim boundaries, and narrative coherence across research-oriented content collections | **Command:** `/review-consistency` - Structured concept review workflow<br>**Agents:** `term-auditor`, `claim-boundary-reviewer`, `narrative-alignment-reviewer` |
